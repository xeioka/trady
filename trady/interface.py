...
class ExchangeInterface(abc.ABC):
    ...
    def get_candlesticks(
        ...
        limit
            Required number of candlesticks. Must belong to [1, `CANDLESTICKS_MAX_LIMIT`].
            Note that if there's not enough candlesticks the method will simply return all of them.
        start_datetime
            Specifies open datetime to start with.
        end_datetime
            Specifies the maximum open datetime.
        """
